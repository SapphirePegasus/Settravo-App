...
export default function AddExpenseScreen() {
    ...
    const handleSubmit = useCallback(async () => {
        ...
        if (isEditMode && existingExpense) {
            ...
            try {
                ...
                applyExpensePatch(tripId, {
                    eventType: 'UPDATE',
                    new: {
                        id: updated.id, trip_id: updated.tripId,
                        paid_by_member: updated.paidByMember, title: updated.title,
        ...
        if (!networkOnline) {
            await enqueueOfflineItem({
                ...
                payload: {
                    ...
                    category, amountMoney: amountPaise!, splits: splitEntries,
                },
            });
        ...
        addExpenseOptimistic, confirmExpense, applyExpensePatch, setSplitsInStore,
